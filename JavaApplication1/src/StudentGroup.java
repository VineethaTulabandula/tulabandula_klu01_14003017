		...
		// Add your implementation here
                try{
                    if(student==null){
                        ...
                        students[last].setId(student.getId());
                        students[last].setFullName(student.getFullName());
                        students[last].setBirthDate(student.getBirthDate());
                        students[last].setAvgMark(student.getAvgMark());
                    }
